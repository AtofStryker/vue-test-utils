...
describeWithShallowAndMount('createLocalVue', mountingMethod => {
  ...
  // })
  describe('Vue global configuration object', () => {
    it('Calls the error handler when an error is throw synchronously', () => {
      const errorHandler = jest.fn().mockImplementation((a,b,c)=> {
        debugger
      })
      const localVue = createLocalVue({
        errorHandler
    ...
    xit('Calls the error handler when an error is throw asynchronously', async () => {
